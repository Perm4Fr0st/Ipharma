            ...
            <tr><td align=right colspan=2><input type=submit value=<?php echo $mysave1;?>>
                            ...
                            if(isset($_GET["txtedit"])){
                                if ($_GET["txtedit"]==""){
                                    ...
                                    $conn->query("update delivery set date1='$_GET[txtdate]',com='$_GET[txtcom]',term='$_GET[txtterm]',delcode='$_GET[txtdelcode]',bid='$_GET[txtbranch]' where id=$_GET[txtedit]");
                                    header("Refresh:0; url=del.php");
                                    }
                                }
                            ...
                            if (isset($_GET["txtedit"])){
                                if($_GET["txtedit"]!=""){
                                    echo "<a href=del.php><button>Add New</button></a>";
                                }
                            }
                            ?>
                                ...
                                while($row=$result->fetch_assoc()){
                                    ...
                                    echo "<tr><td><a href=del.php?txtdel=$row[id]><img src=delete.png width=30></a><a href=del.php?txtedit=$row[id]><img src=edit.png width=20></a><a href=# onclick=showme($row[id])>Buy</a></td><td>$row[date1]</td><td>$row[com]</td><td>$row[term]</td><td>$row[delcode]</td><td>$row[bid]</td><td>$row[amount]</td></tr>";
                                }
                               echo "</table>";
