...
?>
            ...
            <tr><input type=hidden id=txtcashname value='<?php echo $name;?>' readonly>
        </tr>
    ...
    function showmee(){
        ...
        //alert(date);
            if(date == " "|| date == null || date == 0 || date1 == " "|| date1 == null || date1 == 0 || branch == " "|| branch == null || branch == 0 || branch == "Select Branch"){
                ...
                xmlhttp.open("GET", "salesreport.php?txtdate="+date+"&txtdate1="+date1+"&txtbranch="+branch+"&txtcashname="+cashname, true);
                xmlhttp.send();
            }
    }
</script>
