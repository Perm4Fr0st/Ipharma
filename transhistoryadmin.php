...
$type="transfer";
       ...
       // $result=$conn->query("select * from product where flddesc like '%$_GET[txtsearch]%' and bid like'$_GET[txtbranch]'");    
        $result=$conn->query("select code,sum(credit) as total from prodhis where transfer like 'Pending' and date1 between '$_GET[txtdate]' and '$_GET[txtdate1]' group by code order by code");   
